...
// c4
#include "v1751DpppsdTrace10BitReader.h"
...
extern "C"
{
    ...
    #include "ext_h101_v1751_Trace10Bit.h"
}

v1751DpppsdTrace10BitReader::v1751DpppsdTrace10BitReader(EXT_STR_h101_v1751_Trace10Bit_onion* data, size_t offset)
    : c4Reader("v1751DpppsdTrace10BitReader")
    , fNEvent(0)
    , fData(data)
    , fOffset(offset)
    , fOnline(kFALSE)
    , fArray(new TClonesArray("v1751DpppsdTrace10BitData"))
    // , fArrayqdc(new TClonesArray("QDCData"))
{
}

v1751DpppsdTrace10BitReader::~v1751DpppsdTrace10BitReader() { 
    delete fArray;
    // delete fArrayqdc;

}

Bool_t v1751DpppsdTrace10BitReader::Init(ext_data_struct_info* a_struct_info)
{
    Int_t ok;

    EXT_STR_h101_v1751_Trace10Bit_ITEMS_INFO(ok, *a_struct_info, fOffset, EXT_STR_h101_v1751_Trace10Bit, 0);
    ...
    FairRootManager::Instance()->Register("v1751DpppsdTrace10BitData", "FATIMA v1751 Data", fArray, !fOnline);
    fArray->Clear();
...
Bool_t v1751DpppsdTrace10BitReader::Read()
{
    ...
    for (int ich = 0; ich<8; ich++){
        ...
        // FIX
        auto* event = new ((*fArray)[fArray->GetEntriesFast()]) v1751DpppsdTrace10BitData(
...
void v1751DpppsdTrace10BitReader::Reset()
{
    // reset output array
    fArray->Clear();
    // fArrayqdc->Clear();
...
ClassImp(v1751DpppsdTrace10BitReader)
