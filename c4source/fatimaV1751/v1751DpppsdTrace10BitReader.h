#ifndef v1751DpppsdTrace10BitReader_H
#define v1751DpppsdTrace10BitReader_H
...
struct EXT_STR_h101_v1751_Trace10Bit_t;
typedef struct EXT_STR_h101_v1751_Trace10Bit_t EXT_STR_h101_v1751_Trace10Bit;
typedef struct EXT_STR_h101_v1751_Trace10Bit_onion_t EXT_STR_h101_v1751_Trace10Bit_onion;
class ext_data_struct_info;

class v1751DpppsdTrace10BitReader : public c4Reader
{
    public:
        v1751DpppsdTrace10BitReader(EXT_STR_h101_v1751_Trace10Bit_onion*, size_t);

        virtual ~v1751DpppsdTrace10BitReader();
    ...
    private:
        ...
        EXT_STR_h101_v1751_Trace10Bit_onion* fData;
    ...
    public:
        ClassDefOverride(v1751DpppsdTrace10BitReader, 0);
};
