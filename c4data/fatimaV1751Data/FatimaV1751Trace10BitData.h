#ifndef FatimaV1751Trace10BitData_H
#define FatimaV1751Trace10BitData_H
...
class FatimaV1751Trace10BitData : public TObject
{
    public:
        // Default Constructor
        FatimaV1751Trace10BitData();
        ...
        // Destructor
        virtual ~FatimaV1751Trace10BitData() {};
    ...
    public:
        ClassDef(FatimaV1751Trace10BitData, 1);
};
