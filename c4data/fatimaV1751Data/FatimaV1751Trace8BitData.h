#ifndef FatimaV1751Trace8BitData_H
#define FatimaV1751Trace8BitData_H
...
class FatimaV1751Trace8BitData : public TObject
{
    public:
        // Default Constructor
        FatimaV1751Trace8BitData();
        ...
        // Destructor
        virtual ~FatimaV1751Trace8BitData() {};
    ...
    public:
        ClassDef(FatimaV1751Trace8BitData, 1);
};
