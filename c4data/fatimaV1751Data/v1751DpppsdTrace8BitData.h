#ifndef v1751DpppsdTrace8BitData_H
#define v1751DpppsdTrace8BitData_H
...
class v1751DpppsdTrace8BitData : public TObject
{
    public:
        // Default Constructor
        v1751DpppsdTrace8BitData();
        ...
        // Destructor
        virtual ~v1751DpppsdTrace8BitData() {};
        ...
        inline const uint8_t Get_digital_probe_1(const int idx) {
            return digital_probe_1[idx];
        }
        inline const uint8_t Get_digital_probe_2(const int idx) {
            return digital_probe_2[idx];
        }
        ...
        void Set_digital_probe_1_val(uint8_t vdp1, int idx) {
                digital_probe_1[idx] = vdp1;
        }
        void Set_digital_probe_2_val(uint8_t vdp2, int idx) {
                digital_probe_2[idx] = vdp2;
        }
    ...
    protected:
        ...
        uint8_t digital_probe_1[VMEV1751_TRACE_SIZE];
        uint8_t digital_probe_2[VMEV1751_TRACE_SIZE];
        uint16_t flength;
    ...
    public:
        ClassDef(v1751DpppsdTrace8BitData, 1);
};
