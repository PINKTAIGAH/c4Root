...
// c4
#include "FatimaV1751Trace8BitOnlineSpectra.h"
...
FatimaV1751Trace8BitOnlineSpectra::FatimaV1751Trace8BitOnlineSpectra() 
    : FatimaV1751Trace8BitOnlineSpectra("FatimaV1751Trace8BitOnlineSpectra")
    {
        fatima_vme_config = FatimaV1751Configuration::GetInstance();
    }

FatimaV1751Trace8BitOnlineSpectra::FatimaV1751Trace8BitOnlineSpectra(const TString& name, Int_t verbose)
...
InitStatus FatimaV1751Trace8BitOnlineSpectra::Init()
{
    ...
    fHitFatimaV1751 = (TClonesArray*)mgr->GetObject("FatimaV1751Trace8BitData");
    c4LOG_IF(error, !fHitFatimaV1751, "Branch FatimaV1751Trace8BitData not found");
...
void FatimaV1751Trace8BitOnlineSpectra::Reset_Histo() {
...
void FatimaV1751Trace8BitOnlineSpectra::Exec(Option_t* option){
    int mult = 0;
    ...
    if (fHitFatimaV1751) {
        for (Int_t i = 0; i < fHitFatimaV1751->GetEntriesFast(); i++) {
            auto* event = (FatimaV1751Trace8BitData*)fHitFatimaV1751->At(i);
...
void FatimaV1751Trace8BitOnlineSpectra::FinishEvent()
{

}

void FatimaV1751Trace8BitOnlineSpectra::FinishTask()
{
