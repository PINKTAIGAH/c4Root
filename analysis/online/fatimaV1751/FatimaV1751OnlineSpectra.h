#ifndef FatimaV1751OnlineSpectra_H
#define FatimaV1751OnlineSpectra_H
...
class FatimaV1751OnlineSpectra : public FairTask
{
    public:
        FatimaV1751OnlineSpectra();
        FatimaV1751OnlineSpectra(const TString& name, Int_t verbose = 1);

        virtual ~FatimaV1751OnlineSpectra();
    ...
    public:
        ClassDef(FatimaV1751OnlineSpectra, 1);
};
