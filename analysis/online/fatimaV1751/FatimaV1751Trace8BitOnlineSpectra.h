#ifndef FatimaV1751Trace8BitOnlineSpectra_H
#define FatimaV1751Trace8BitOnlineSpectra_H
...
class FatimaV1751Trace8BitOnlineSpectra : public FairTask
{
    public:
        FatimaV1751Trace8BitOnlineSpectra();
        FatimaV1751Trace8BitOnlineSpectra(const TString& name, Int_t verbose = 1);

        virtual ~FatimaV1751Trace8BitOnlineSpectra();
    ...
    public:
        ClassDef(FatimaV1751Trace8BitOnlineSpectra, 1);
};
